...
Original file is located at
    https://colab.research.google.com/drive/1q9RIqYYprg9wzzZt-trCGH5Jf4WJGdUr

uni: jha2137, name: Jacob Atkins
"""
...
class SignLanguage:
    ...
    def create_model(self):
        ...
        model.add(MaxPooling2D((2,2))) # Add parameters
    ...
    def prepare_data(self, images, labels):
        ...
        x_train, x_test, y_train, y_test = train_test_split(images, labels, test_size = .2, random_state = np.random.seed(1))
    ...
    def train(self, batch_size:int=128, epochs:int=50, verbose:int=1):
        ...
        """
        history = self.model.fit(self.data["train"][0], self.data["train"][1], batch_size = batch_size, epochs = epochs, verbose = verbose, validation_split = .1)
        return history
    ...
    def predict(self, data):
        ...
        new_data = data.reshape((len(data), 28, 28, 1))
